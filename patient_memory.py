...
class PatientMemory:
    ...
    def get_patient_profile(self, patient_id: int) -> dict:
        ...
        try:
            ...
            patient_doc = self.collections['patients'].get(str(patient_id)).content_as[dict]
            ...
            print(f"[Memory System] Retrieved complete profile for patient {patient_id}")
            return profile
    ...
    def _get_patient_data(self, collection_name: str, patient_id: int) -> list:
        ...
        try:
            ...
            print(f"[Memory System] Error querying {collection_name} for patient {patient_id}: {e}")
            return []
